...
Bullet::Bullet(float X, float Y, float Angle, float Size, float Speed, float Damage, Texture2D &BulletTexture, Entity& Owner, Game &game) : Entity(
    BulletTexture, BoundingBox, Speed, game), Owner() {
    this->Speed = Speed;
...
void Bullet::Attack(Entity& entity) {
